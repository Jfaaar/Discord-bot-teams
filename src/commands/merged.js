...
// Target voice channel ID for /merged command
const TARGET_CHANNEL_ID = '1460674139210645517';

module.exports = {
    data: new SlashCommandBuilder()
        .setName('merged')
        .setDescription('Move everyone in the server to the Merged voice channel'),
